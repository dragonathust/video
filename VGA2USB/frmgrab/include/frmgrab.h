/****************************************************************************
 *
 * $Id: frmgrab.h 10689 2010-08-20 17:31:12Z monich $
 *
...
typedef V2U_UINT32 (*FrmGrabMemSize)(void* param, int w, int h,V2U_UINT32 fmt);
...
/**
 * FrmGrab_SetAlloc2 allows to set another callback FrmGrabMemSize which
 * calculates the size of the buffer necessary to capture the specified
 * resolution.
 */
void FrmGrab_SetAlloc2(FrmGrabber* fg, const FrmGrabMemCB2* memcb,void* param);
