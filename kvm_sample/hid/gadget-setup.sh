...
DESCRIPTOR=/usr/sbin/kybd-descriptor.bin  #  binary blob of report descriptor, see HID class spec
UDC=ast_vdev_udc_1                                                     #  name of the UDC driver to use (found in /sys/class/udc/)   

# gadget configuration
#modprobe libcomposite                                             #  load configfs
mount -t configfs none /sys/kernel/config                                    #  mount configfs as type configfs at /config
mkdir /sys/kernel/config/usb_gadget/keyboardgadget                           #  make a new gadget skeleton
cd /sys/kernel/config/usb_gadget/keyboardgadget                              #  cd to gadget dir
